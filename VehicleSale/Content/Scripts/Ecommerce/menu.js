...
(function ($) {
    var EcommerceOpenMenuItems = "Ecommerce-open-menu-items";
    function storeOpenTabs() {
        var data = $("li[data-menu].open").map(function () {
            return $(this).data('menu');
        }).get().join(",");
        store.set(EcommerceOpenMenuItems, data);
    }
    function openNavItems() {
        var items = store.get(EcommerceOpenMenuItems) || '';
    ...
    $(document).ready(function () {
        $('li[data-menu] > [data-toggle=dropdown-Ecommerce]').on('click', function (event) {
